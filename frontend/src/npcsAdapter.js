...
//random function form submit
    ...
    sendPatchRequest(npcId){
        ...
        const health = document.getElementById(`update-health-${npcId}`).value
        const armor = document.getElementById(`update-armor-${npc-id}`).value
        ...
        const encounter = document.getElementById(`update-encounter-${npcId}`).value
        ...
        .then(res => {
            ...
            npc.updateNpcOnDom(res.data.attributes)
